  ...
  <div class="login-box-body">
    ...
    $checked = false;
      if (isset($_POST["login"])) {
        ...
        $checked =false;
        $sql = "
        SELECT `acc_id`, `acc_name`, `password`, `phone`, `email`, `address`, `date_create` 
        FROM `account` 
        WHERE `email` = '$email';
         ";
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="remember" <?php echo ($checked)?"checked":""; ?>  value="1" id="remember" /> Remember Me
            </label>
          </div>
        </div>
        <!-- /.col -->
