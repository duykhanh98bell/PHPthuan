    ...
    <?php  
      if (isset($_POST["addNew"])) {
        ...
        if (isset($_POST["addNew"])) {
          ...
          $sqledit =" 
          UPDATE `product` 
          SET `pro_name`='$pro_name',`cat_id`='$cat_id',`style_id`='$style_id',`size_id`='$size_id',`colors_id`='$colors_id',`brand_id`='$brand_id',`price`='$Price',`sale_off`='$Sale',`img`='$fileIMG',`desciption`='$Desception',`status`='$status',`date_create`='$date_create' 
          WHERE pro_id = '$id'
          ";
